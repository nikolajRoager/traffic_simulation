...
WARNING
IT IS EXPECTED THAT ALL ROADS AND NODES ARE DELETED AT THE SAME TIME, CALLING MEMBER FUNCTIONS AFTER DELETING THE ONE LIST BUT NOT THE OTHER WILL RESULT IN UNDEFINED BEHAVIOR.
